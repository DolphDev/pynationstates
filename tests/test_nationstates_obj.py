...
# # from nationstates.exceptions import CollectError, APIError
#
#
#
# # No requests are actually made for these tests, this just silences the ua warning
# ua = ""
# nationstates = ns.Nationstates("AUTOMATED TRAVIS BUILD OF PYNATIONSTATES || dolphdevgithub@gmail.com")
#
