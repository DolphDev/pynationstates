...
""" OLD TESTS, THESE FUNCTIONS ARE DEPRECIATED"""

import nationstates


class nationstates_methods_version_old(unittest.TestCase):
...
class nationstates_methods_set_shard_old(unittest.TestCase):
...
class nationstates_method_set_value_old(unittest.TestCase):
...
class nationstates_method_set_useragent_method_old(unittest.TestCase):
