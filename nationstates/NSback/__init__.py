...
class Api(ApiCall):
    ...
    def __init__(
        ...
        :param limit: (optional) Will set the limit for the request.
            Only used on shards that accepted a limit. Global Limit.

        :param parse_args: (optional) Pre-processed info 
            (That is generated by the wrapper or by the user)
